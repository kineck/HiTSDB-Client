package com.aliyun.hitsdb.client.error;
...
public class TestHiTSDBClientBatchPutExceptionCallback {
    ...
    public void init() throws HttpClientInitException {
        ...
        HiTSDBConfig config = HiTSDBConfig.address("127.0.0.1", 8242).listenBatchPut(pcb).config();
